...
!function() {
    ...
    function Ca(t, e, n) {
        t && (n ? (n = "",
        e && o.test(e) && (n = ' id="' + e + '"'),
        o.test(t) && u.write("<script" + n + ' src="' + t + '"><\/script>')) : ((n = u.createElement("script")).type = "text/javascript",
        n.async = !0,
        n.src = t,
        e && (n.id = e),
    ...
    var l = window
      ...
      , v = function(t, e, n) {
        ...
        if (!i)
            return !1;
        var r = new i;
        return "withCredentials"in r && (r.open("POST", t, !0),
        r.withCredentials = !0,
      ...
      , y = function(t, e, n) {
        1 <= 100 * Math.random() || Ra("?") || (t = ["t=error", "_e=" + t, "_v=j47", "sr=1"],
        e && t.push("_f=" + e),
        n && t.push("_m=" + za(n.substring(0, 100))),
        t.push("aip=1"),
        t.push("z=" + w()),
        p(Za() + "/collect", t.join("&"), ya))
    };
    function Ja(t) {
    ...
    fb.prototype.D = function(t) {
        ...
        (e = t.get(D)) != ya && sa(e) && (t.set(D, ya, !0),
        setTimeout(e, 10))
    }
    ;
    function hb() {
    ...
    function Ta(t) {
        var e = mb(t, mt);
        if (500 <= e && J(15),
        "transaction" != (n = lb(t, M)) && "item" != n) {
            var n = mb(t, yt)
              , i = (new Date).getTime()
              , r = mb(t, bt);
            if (0 == r && t.set(bt, i),
            0 < (r = Math.round(2 * (i - r) / 1e3)) && (n = Math.min(n + r, 20),
            t.set(bt, i)),
            n <= 0)
                throw "abort";
            t.set(yt, --n)
    ...
    function pd(t) {
        if ("cookie" == lb(t, qt)) {
            ...
            if ("auto" != r)
                ...
                if (J(32),
                n = [],
                4 != (r = Fa().split(".")).length || (s = r[r.length - 1],
                parseInt(s, 10) != s)) {
    ...
    function rd(t) {
        if (t.get(Xt)) {
            ...
            t.set(ht, i.R),
            (e = Xc("__utmz", n, e)) && i.hash == e.hash && t.set(pt, e.R))
        }
    }
    function vd(t, e, n) {
        for (var i, r = [], a = [], o = 0; o < t.length; o++) {
            var s = t[o];
            s.H[n] == e ? r.push(s) : null == i || s.H[n] < i ? (a = [s],
    ...
    var ne = function(t) {
        ...
        if (re(e) || oe(e)) {
            var n = e[Q];
            null == n || 1 / 0 == n || isNaN(n) || (0 < n ? (se(e, et),
            se(e, rt),
            se(e, it),
            se(e, tt),
            se(e, nt),
      ...
      , re = function(t) {
        ...
        t[rt] = e.connectEnd - e.connectStart,
        t[it] = e.responseStart - e.requestStart,
        t[tt] = e.responseEnd - e.responseStart,
        t[nt] = e.fetchStart - n,
        t[at] = e.domInteractive - n,
        t[ot] = e.domContentLoadedEventStart - n,
        !0)
    }
      , oe = function(t) {
        if (l.top != l)
    ...
    var ge = new RegExp(/^https?:\/\/([^\/:]+)/)
      , he = /(.*)([?&#])(?:_ga=[^&#]*)(?:&?)(.*)/;
    function Ic(t, e) {
        for (var n = new Date, i = (r = l.navigator).plugins || [], r = (n = [t, r.userAgent, n.getTimezoneOffset(), n.getYear(), n.getDate(), n.getHours(), n.getMinutes() + e],
        0); r < i.length; ++r)
    ...
    function Jd(t, e, n) {
        ...
        this.Y = e,
        hd(new gd(100), t) && (J(30),
        this.pa = !0)
    }
    function Pd(t, e) {
        var n, i = t.b;
        i.get("dcLoaded") || (pa(i, 29),
        (e = e || {})[jt] && (n = Wa(e[jt])),
        function(n, t) {
            var i = t.get(Dt);
            t.set(Dt, function(t) {
        ...
        }(n = new Jd(i,"https://stats.g.doubleclick.net/r/collect?t=dc&aip=1&_r=3&",n), i),
        i.set("dcLoaded", !0))
    }
    function Qd(t) {
        if (!t.get("dcLoaded") && "cookie" == t.get(qt)) {
            ...
            Ce(e, t),
            Se(e, t),
            t.get(e.U) && (t.set(ee, 1, !0),
            t.set(te, Za() + "/r/collect", !0))
        }
    }
    function Vd(t) {
        function b(t, e) {
        ...
        function(t, e, n) {
            if (!me) {
                ...
                var r = l.name
                  , a = /^#?gaso=([^&]*)/;
                (r = (i = (i = i && i.match(a) || r && r.match(a)) ? i[1] : Ua("GASO")[0] || "") && i.match(/^(?:!([-0-9a-z.]{1,40})!)?([-.\w]{10,1200})$/i)) && (Va("GASO", "" + i, n, e, t, 0),
                window._udo || (window._udo = e),
                window._utcp || (window._utcp = n),
                t = r[1],
                Ca("https://www.google.com/analytics/web/inpage/pub/inpage.js?" + (t ? "prefix=" + t + "&" : "") + w(), "_gasojs")),
                me = !0
            }
        }(this.b.get(Ft), this.b.get(zt), this.b.get(Jt))
    }
    var me, be = /^(GTM|OPT)-[A-Z0-9]+$/, ye = /;_gaexp=[^;]*/g, we = /;((__utma=)|([^;=]+=GAX?\d+\.))[^;]*/g, Ce = function(t, e) {
    ...
    }, xe = /^gtm\d+$/, Te = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, Ae = function(t, e) {
        if ("cookie" == lb(t, qt)) {
            var n;
            le = !1;
            t: {
                ...
                if (i && !(i.length < 1)) {
                    ...
                    for (var r = 0; r < i.length; r++) {
                        var a, o = (a = i[r].split(".")).shift();
                        (a = ("GA1" == o || "1" == o) && 1 < a.length ? (1 == (o = a.shift().split("-")).length && (o[1] = "1"),
                        o[0] *= 1,
                        o[1] *= 1,
                        {
                            H: o,
            ...
            n || (n = lb(t, zt),
            n = null != (n = Xc("__utma", i = lb(t, Ut) || Fa(), n)) ? (J(10),
            n.O[1] + "." + n.O[2]) : void 0),
            n && (t.data.set(Wt, n),
            le = !0)
        }
        if (n = t.get($t),
        (r = Ea(u.location[n ? "href" : "search"], "_ga")) && (t.get(Kt) ? -1 == (n = r.indexOf(".")) ? J(22) : (i = r.substring(n + 1),
        "1" != r.substring(0, n) ? J(22) : -1 == (n = i.indexOf(".")) ? J(22) : (r = i.substring(0, n)) != Ic(n = i.substring(n + 1), 0) && r != Ic(n, -1) && r != Ic(n, -2) ? J(23) : (J(11),
        t.data.set(Wt, n))) : J(21)),
        e && (J(9),
        t.data.set(Wt, za(e))),
        !t.get(Wt))
        ...
        var a = (r = u.body) && r.clientWidth && r.clientHeight
          , o = [];
        if (n && n.clientWidth && n.clientHeight && ("CSS1Compat" === u.compatMode || !a) ? o = [n.clientWidth, n.clientHeight] : a && (o = [r.clientWidth, r.clientHeight]),
        n = o[0] <= 0 || o[1] <= 0 ? "" : o.join("x"),
        t.set(F, n),
        t.set(z, function fc() {
            var t, e, n;
        ...
        t.set(W, u.characterSet || u.charset),
        t.set(j, e && "function" == typeof e.javaEnabled && e.javaEnabled() || !1),
    ...
    function ae(t) {
        if (sa(t[0]))
            ...
            this.W = this.a[2]) : this.a[1] && (ua(this.a[1]) ? this.X = this.a[1] : this.W = this.a[1]))),
            e = t[1],
            t = t[2],
            !this.C)
                throw "abort";
      ...
      , Re = function(t, e, n, i, r) {
        if (!sa(Le.get(e)) && !De.get(e)) {
            ...
            be.test(e)) {
                ...
                "t0" != a && (i.target = a),
                Ra(String(t.get("trackingId"))) || (i.ja = String(t.get(Wt)),
                i.ka = Number(t.get(Ht)),
                t = n.palindrome ? we : ye,
            ...
            !n && Me.hasOwnProperty(e) ? (J(39),
            n = e + ".js") : J(43),
            n && (n && 0 <= n.indexOf("/") || (n = (O || Da() ? "https:" : "http:") + "//www.google-analytics.com/plugins/ua/" + n),
            t = (i = We(n)).protocol,
            n = u.location.protocol,
            ("https:" == t || t == n || "http:" == t && "http:" == n) && Be(i) && (Ca(i.url, void 0, r),
            De.set(e, !0)))
        }
    }
      , Ne = function(t, e) {
    ...
    He.D = function(t) {
        ...
        e = He.f.concat(e);
        for (He.f = []; 0 < e.length && !He.v(e[0]) && (e.shift(),
        !(0 < He.f.length)); )
            ;
        He.f = He.f.concat(e)
    }
    ...
    He.J = function(t) {
        for (var e = [], n = 0; n < arguments.length; n++)
            try {
                ...
                i.g ? ie(i.a[0], i.a[1]) : (i.i && (i.ha = Re(i.c, i.a[0], i.X, i.W)),
                e.push(i))
            } catch (t) {}
        return e
    }
        ...
        try {
            if (t.u)
                ...
                if (t.A)
                    ...
                    if (t.i) {
                        if (t.ha && (t.ha = Re(t.c, t.a[0], t.X, t.W)),
                        !Pe(t.a[0], e, t.W))
                            return !0
                    } else if (t.K) {
                        var n = t.C
    ...
    Ve.create = function(t) {
        ...
        e[Bt] || (e[Bt] = "t0");
        var n = "" + e[Bt];
        return Ve.h[n] ? Ve.h[n] : (e = new Vd(e),
        Ve.h[n] = e,
        Ve.P.push(e),
        e)
    }
    ...
    Ve.N = function() {
        ...
        if (!t || 42 != t.answer) {
            ...
            X("get", e = Vd.prototype, e.get, 7),
            X("set", e, e.set, 4),
            X("send", e, e.send),
            X("requireSync", e, e.ma),
            X("get", e = ib.prototype, e.get),
            X("set", e, e.set),
            !Da() && !O) {
                t: {
...
var tns = function() {
    ...
    function whichProperty(e) {
        ...
        for (var t = document.createElement("fakeelement"), r = (e.length,
        0); r < e.length; r++) {
            var a = e[r];
            if (void 0 !== t.style[a])
                return a
    ...
    var tn = function(L) {
        ...
        var m = e.tC ? checkStorageValue(e.tC) : setLocalStorage(e, "tC", function calc() {
          ...
          , b = e.tPL ? checkStorageValue(e.tPL) : setLocalStorage(e, "tPL", function percentageLayout() {
            var t, e = document, n = getBody(), i = setFakeBody(n), r = e.createElement("div"), a = e.createElement("div"), o = "";
          ...
          , o = e.t3D ? checkStorageValue(e.t3D) : setLocalStorage(e, "t3D", function has3DTransforms(t) {
            ...
            if (!window.getComputedStyle)
                return !1;
            var e, n = document, i = getBody(), r = setFakeBody(i), a = n.createElement("p"), o = 9 < t.length ? "-" + t.slice(0, -9).toLowerCase() + "-" : "";
            return o += "transform",
        ...
        !(L.container.children.length < 1)) {
            ...
            var E, W, H = "horizontal" === L.axis, x = M.createElement("div"), V = M.createElement("div"), F = L.container, T = F.parentNode, A = F.outerHTML, j = F.children, z = j.length, J = getWindowWidth(), G = !1;
            I && setBreakpointZone(),
            P && (F.className += " tns-vpfix");
            var O, k, U, X = L.autoWidth, q = getOption("fixedWidth"), K = getOption("edgePadding"), $ = getOption("gutter"), Z = getViewportWidth(), Y = getOption("center"), Q = X ? 1 : Math.floor(getOption("items")), tt = getOption("slideBy"), et = L.viewportMax || L.fixedWidthViewportWidth, nt = getOption("arrowKeys"), it = getOption("speed"), rt = L.rewind, at = !rt && L.loop, ot = getOption("autoHeight"), st = getOption("controls"), lt = getOption("controlsText"), ut = getOption("textDirection"), ct = getOption("nav"), dt = getOption("touch"), ft = getOption("mouseDrag"), gt = getOption("autoplay"), ht = getOption("autoplayTimeout"), pt = getOption("autoplayText"), vt = getOption("autoplayHoverPause"), mt = getOption("autoplayResetOnVisibility"), bt = function createStyleSheet(t) {
            ...
            }() : 0, St = P ? z + 2 * Ct : z + Ct, Et = !(!q && !X || at), xt = q ? getRightBoundary() : null, Tt = !P || !at, At = H ? "left" : "top", Ot = "", kt = "", Lt = q ? function() {
            ...
            , Mt = getStartIndex(getOption("startIndex")), Dt = Mt, It = (getCurrentSlide(),
            0), _t = X ? null : Lt(), Pt = L.preventActionWhenRunning, Rt = L.swipeAngle, Nt = !Rt || "?", Bt = !1, Wt = L.onInit, Ht = new Events, Vt = " tns-slider tns-" + L.mode, Ft = F.id || function getSlideId() {
                var t = window.tnsId;
                return window.tnsId = t ? t + 1 : 1,
                "tns" + window.tnsId
            }(), jt = getOption("disable"), zt = !1, Jt = L.freezable, Gt = !(!Jt || X) && getFreeze(), Ut = !1, Xt = {
                ...
                mouseup: onPanEnd,
                mouseleave: onPanEnd
            }, te = null, ee = hasOption("controls"), ne = hasOption("nav"), ie = !!X || L.navAsThumbnails, re = hasOption("autoplay"), ae = hasOption("touch"), oe = hasOption("mouseDrag"), se = "tns-slide-active", le = "tns-complete", ue = {
            ...
            if (ae || oe)
                var He, Ve, Fe = {}, je = {}, ze = !1, Je = H ? function(t, e) {
                    return t.x - e.x
                }
                : function(t, e) {
                    return t.y - e.y
            ...
            function initStructure() {
                ...
                Vt += " tns-" + L.axis,
                F.className += Vt,
                P ? ((E = M.createElement("div")).id = Ft + "-mw",
                E.className = "tns-ovh",
                x.appendChild(E),
                E.appendChild(V)) : x.appendChild(V);
                if (ot) {
            ...
            function initSheet() {
                ...
                H && (b || X ? (addCSSRule(bt, "#" + Ft + " > .tns-item", "font-size:" + v.getComputedStyle(j[0]).fontSize + ";", getCssRulesLength(bt)),
                addCSSRule(bt, "#" + Ft, "font-size:0;", getCssRulesLength(bt))) : P && forEach(j, function(t, e) {
                ...
                if (D) {
                    ...
                    P && (i = H && !X ? "width:" + getContainerWidth(L.fixedWidth, L.gutter, L.items) + ";" : "",
                    ...
                    P || (y && (i += getTransitionDurationStyle(it)),
                ...
                if (I && D)
                    for (var r in I) {
                        ...
                        !P && "speed"in a && (y && (u += getTransitionDurationStyle(f)),
            ...
            : function() {
              ...
              , Ue = P ? function() {
                ...
                te = setTimeout(onTransitionEnd, it + 100)) : onTransitionEnd()) : function jsTransform(t, e, n, i, r, a, o) {
                    var s = Math.min(a, 10)
                      , l = 0 <= r.indexOf("%") ? "%" : "px"
                      , u = (r = r.replace(l, ""),
        ...
        function initSliderTransformCore() {
            H && !X || (setSlidePositions(),
            X ? (xt = getRightBoundary(),
            Jt && (Gt = getFreeze()),
            _t = Lt(),
            resetVariblesWhenDisable(jt || Gt)) : updateContentWrapperHeight()),
            P && doContainerTransformSilent(),
            initTools(),
            initEvents()
        }
        function initTools() {
            ...
            U = x.querySelector(".tns-liveregion .current"),
            re) {
                var t = gt ? "stop" : "start";
                Ne ? setAttrs(Ne, {
                    "data-action": t
                }) : L.autoplayButtonOutput && (x.insertAdjacentHTML(getInsertPosition(L.autoplayPosition), '<button data-action="' + t + '">' + We[0] + t + We[1] + pt[0] + "</button>"),
            ...
            ee && (ge || pe && ve || (x.insertAdjacentHTML(getInsertPosition(L.controlsPosition), '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button data-controls="prev" tabindex="-1" aria-controls="' + Ft + '">' + lt[0] + '</button><button data-controls="next" tabindex="-1" aria-controls="' + Ft + '">' + lt[1] + "</button></div>"),
            ge = x.querySelector(".tns-controls")),
            pe && ve || (pe = ge.children[0],
            ve = ge.children[1]),
            ...
            ge ? addEvents(ge, Xt) : (addEvents(pe, Xt),
            addEvents(ve, Xt))),
            disableUI()
        }
        function initEvents() {
        ...
        function resizeTasks(t) {
            if (G) {
                ...
                var e, n = W, i = !1;
                I && (setBreakpointZone(),
                (e = n !== W) && Ht.emit("newBreakpointStart", info(t)));
                var r, a, o = Q, s = jt, l = Gt, u = nt, c = st, d = ct, f = dt, g = ft, h = gt, p = vt, v = mt, m = Mt;
                if (e) {
                    var b = q
                      , y = ot
                      , w = lt
                ...
                D || (K = getOption("edgePadding"),
                $ = getOption("gutter"))),
                resetVariblesWhenDisable(jt),
                Z = getViewportWidth(),
                H && !X || jt || (setSlidePositions(),
                H || (updateContentWrapperHeight(),
                i = !0)),
                ...
                (a = Q !== o) && (q || X || (_t = Lt()),
                Ge())),
                e && jt !== s && (jt ? disableSlider() : function enableSlider() {
                    if (!zt)
                        return;
                    if (bt.disabled = !1,
                    F.className += Vt,
                ...
                Jt && (e || q || X) && (Gt = getFreeze()) !== l && (Gt ? (doContainerTransform(getContainerTransformValue(getStartIndex(0))),
                ...
                i = !0)),
                resetVariblesWhenDisable(jt || Gt),
                gt || (vt = mt = !1),
                nt !== u && (nt ? addEvents(M, Zt) : removeEvents(M, Zt)),
                st !== c && (st ? ge ? showElement(ge) : (pe && showElement(pe),
                ve && showElement(ve)) : ge ? hideElement(ge) : (pe && hideElement(pe),
                ve && hideElement(ve))),
                ...
                gt !== h && (gt ? (Ne && showElement(Ne),
                De || _e || startAutoplay()) : (Ne && hideElement(Ne),
                De && stopAutoplay())),
                vt !== p && (vt ? addEvents(F, Kt) : removeEvents(F, Kt)),
                mt !== v && (mt ? addEvents(M, $t) : removeEvents(M, $t)),
                e) {
                    if (q === b && Y === C || (i = !0),
                    ot !== y && (ot || (V.style.height = "")),
                    st && lt !== w && (pe.innerHTML = lt[0],
                    ve.innerHTML = lt[1]),
                    Ne && pt !== S) {
                        var T = gt ? 1 : 0
                          , A = Ne.innerHTML
                    ...
                    Y && (q || X) && (i = !0);
                if ((a || q && !X) && (Se = getPages(),
                updateNavVisibility()),
                (r = Mt !== m) ? (Ht.emit("indexChanged", info()),
                i = !0) : a ? r || additionalUpdates() : (q || X) && (doLazyLoad(),
                updateSlideStatus(),
                updateLiveRegion()),
                !a && P || function updateGallerySlidePositions() {
                ...
                !jt && !Gt) {
                    if (e && !D && (ot === autoheightTem && it === speedTem || update_carousel_transition_duration(),
                    K === x && $ === E || (V.style.cssText = getInnerWrapperStyles(K, $, q, it, ot)),
                    H)) {
        ...
        function disableUI() {
            ...
            st || (ge ? hideElement(ge) : (pe && hideElement(pe),
            ve && hideElement(ve)))
        }
        function enableUI() {
            gt && Ne && showElement(Ne),
            ct && we && showElement(we),
            st && (ge ? showElement(ge) : (pe && showElement(pe),
            ve && showElement(ve)))
        }
        function freezeSlider() {
            if (!Ut) {
                if (K && (V.style.margin = "0px"),
                Ct)
                    for (var t = "tns-transparent", e = Ct; e--; )
                        P && Ye(j[e], t),
                        Ye(j[St - e - 1], t);
        ...
        function disableSlider() {
            if (!zt) {
                if (bt.disabled = !0,
                F.className = F.className.replace(Vt.substring(1), ""),
                removeAttrs(F, ["style"]),
                at)
                    for (var t = Ct; t--; )
                        P && hideElement(j[t]),
                        hideElement(j[St - t - 1]);
                if (H && P || removeAttrs(V, ["style"]),
                !P)
                    for (var e = Mt, n = Mt + z; e < n; e++) {
                        var i = j[e];
                        removeAttrs(i, ["style"]),
        ...
        function getVisibleSlideRange(t) {
            ...
            X)
                ...
                if (q) {
                    var e = q + $;
                    n = Y || K ? (a = Math.floor(i / e),
                    Math.ceil(r / e - 1)) : a + Math.ceil(Z / e) - 1
                } else if (Y || K) {
                    var o = Q - 1;
                    if (n = Y ? (a -= o / 2,
                    Mt + o / 2) : Mt + o,
        ...
        function render(t, e) {
            Tt && Ge(),
            Mt === Dt && !e || (Ht.emit("indexChanged", info()),
            Ht.emit("transitionStart", info()),
            ot && doAutoHeight(),
        ...
        function onTransitionEnd(t) {
            ...
            te = null,
            P || Bt) {
                if (Ht.emit("transitionEnd", info(t)),
                !P && 0 < wt.length)
                ...
                if (!t || !P && t.target.parentNode === F || t.target === F && strTrans(t.propertyName) === strTrans(At)) {
                    if (!Tt) {
                        var i = Mt;
                        Ge(),
                        Mt !== i && (Ht.emit("indexChanged", info()),
                        doContainerTransformSilent())
                    }
                    "inner" === _ && Ht.emit("innerLoaded", info()),
                    Dt = Mt
        ...
        function goTo(t, e) {
            if (!Gt)
                if ("prev" === t)
                    ...
                    var n = getAbsIndex()
                      , i = 0;
                    if ("first" === t ? i = -n : "last" === t ? i = P ? z - Q - n : z - 1 - n : ("number" != typeof t && (t = parseInt(t)),
        ...
        function onPanStart(t) {
            ...
            je.x = Fe.x = e.clientX,
            je.y = Fe.y = e.clientY,
            P && (He = parseFloat(F.style[At].replace(Ot, "")),
            resetDuration(F, "0s"))
        }
